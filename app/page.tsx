...
const lessons = [lessonOne, lessonTwo, lessonThree, lessonFour, lessonFive, lessonSix, lessonSeven, lessonEight, lessonNine];
    ...
    <main className="app-shell">
      ...
      {view === "home" && (
        <section className="home-view">
          <div className="eyebrow">Ваш путь · 9 из 100 уроков готовы</div>
