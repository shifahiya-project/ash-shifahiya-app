    ...
    rules: [
      {
        ...
        term: "إِضَافَةٌ",
        explanation:
          "أُسْتَاذُ هَذَا التِّلْمِيذِ — «наставник этого ученика». Первым идёт вещь, вторым — тот, кому она принадлежит. Первое слово называют مُضَافٌ, второе — مُضَافٌ إِلَيْهِ, а всю связку — إِضَافَةٌ.",
        examples: [
      ...
      },
      {
        ...
        term: "جَرٌّ",
        explanation:
          "У مُضَافٌ إِلَيْهِ окончание «-и»: التِّلْمِيذِ, الأُسْتَاذِ. Это جَرٌّ. Сравните с رَفْعٌ из первого урока, где было «-у»: по одному звуку на конце слышно, владелец это или подлежащее.",
        examples: [
          { arabic: "التِّلْمِيذِ", russian: "ученика", note: "جَرٌّ" },
          { arabic: "الأُسْتَاذِ", russian: "наставника", note: "جَرٌّ" },
          { arabic: "التَّلَامِيذِ", russian: "учеников", note: "جَرٌّ" },
        ],
      },
      {
        kind: "nahw",
        ...
        explanation:
          "مُضَافٌ теряет и танвин, и الـ: говорят أُسْتَاذُ التِّلْمِيذِ, а не الأُسْتَاذُ التِّلْمِيذِ. Определённость приходит к нему от второго слова: раз ученик определённый, то и наставник — тот самый.",
        examples: [
          { arabic: "أُسْتَاذُ التِّلْمِيذِ", russian: "наставник ученика", note: "مُضَافٌ без الـ" },
    ...
    questions: [
      {
        ...
        explanation: "В إِضَافَةٌ первым стоит вещь, вторым — владелец.",
      },
      {
        prompt: "Какое слово в связке تِلْمِيذُ الأُسْتَاذِ является مُضَافٌ إِلَيْهِ?",
        promptLang: "ru",
        answer: "الأُسْتَاذِ",
        options: ["الأُسْتَاذِ", "تِلْمِيذُ", "оба слова"],
        explanation: "مُضَافٌ إِلَيْهِ — второе имя, владелец; оно и стоит в جَرٌّ.",
      },
      {
        prompt: "Какое окончание получает второе имя связки?",
        promptLang: "ru",
        answer: "«-и», это جَرٌّ",
        options: ["«-и», это جَرٌّ", "«-у», это رَفْعٌ", "танвин «-ун»"],
        explanation: "التِّلْمِيذِ, الأُسْتَاذِ — родительный падеж, جَرٌّ.",
      },
      {
        ...
        explanation: "مُضَافٌ не берёт ни артикля, ни танвина.",
      },
      {
        ...
        explanation: "Вещь впереди, владелец следом и в جَرٌّ.",
      },
      {
        prompt: "Откуда مُضَافٌ берёт определённость, если артикля у него нет?",
        promptLang: "ru",
      ...
      },
      {
        ...
        explanation: "Первым стоит то, о чём речь, — ученики; наставники идут вторыми и в جَرٌّ.",
      },
    ],
  },
};
