...
export const lessonEight: Lesson = {
  ...
  grammar: {
    title: "Сопряжение: чей и что",
    intro: "«Наставник этого ученика» — здесь нет ни предлога, ни окончания принадлежности. Работает сам порядок слов, и его стоит разобрать.",
    rules: [
      {
        kind: "nahw",
        title: "Два имени подряд",
        term: "إِضَافَةٌ",
        termSound: "идафа",
        explanation:
          "أُسْتَاذُ هَذَا التِّلْمِيذِ — «наставник этого ученика». Первым идёт вещь, вторым — тот, кому она принадлежит. Первое слово называют مُضَافٌ — «мудаф», второе — مُضَافٌ إِلَيْهِ — «мудаф иляйхи», а всю связку — إِضَافَةٌ, «идафа».",
        examples: [
          { arabic: "أُسْتَاذُ هَذَا التِّلْمِيذِ", russian: "наставник этого ученика" },
          { arabic: "تِلْمِيذُ ذَلِكَ الأُسْتَاذِ", russian: "ученик того наставника" },
          { arabic: "أَسَاتِذَةُ هَؤُلَاءِ التَّلَامِيذِ", russian: "наставники этих учеников" },
        ],
      },
      {
        kind: "nahw",
        title: "Второе имя стоит в родительном падеже",
        term: "جَرٌّ",
        termSound: "джарр",
        explanation:
          "У мудаф иляйхи окончание «-и»: التِّلْمِيذِ, الأُسْتَاذِ. Это جَرٌّ — «джарр». Сравните с رَفْعٌ из первого урока, где было «-у»: по одному звуку на конце слышно, владелец это или подлежащее.",
        examples: [
          { arabic: "التِّلْمِيذِ", russian: "ученика", note: "جَرٌّ — джарр" },
          { arabic: "الأُسْتَاذِ", russian: "наставника", note: "джарр" },
          { arabic: "التَّلَامِيذِ", russian: "учеников", note: "джарр" },
        ],
      },
      {
        kind: "nahw",
        title: "У первого имени нет ни танвина, ни артикля",
        explanation:
          "Мудаф теряет и танвин, и الـ: говорят أُسْتَاذُ التِّلْمِيذِ, а не الأُسْتَاذُ التِّلْمِيذِ. Определённость приходит к нему от второго слова: раз ученик определённый, то и наставник — тот самый.",
        examples: [
          { arabic: "أُسْتَاذُ التِّلْمِيذِ", russian: "наставник ученика", note: "мудаф без الـ" },
          { arabic: "تِلْمِيذُ الأُسْتَاذِ", russian: "ученик наставника" },
          { arabic: "طَبِيبُ التَّاجِرِ", russian: "врач торговца" },
        ],
      },
    ],
    questions: [
      {
        prompt: "Что значит أُسْتَاذُ هَذَا التِّلْمِيذِ?",
        promptLang: "ru",
        answer: "Наставник этого ученика",
        options: ["Наставник этого ученика", "Ученик этого наставника", "Этот ученик — наставник"],
        explanation: "В идафе первым стоит вещь, вторым — владелец.",
      },
      {
        prompt: "Какое слово в связке تِلْمِيذُ الأُسْتَاذِ является вторым — мудаф иляйхи?",
        promptLang: "ru",
        answer: "الأُسْتَاذِ",
        options: ["الأُسْتَاذِ", "تِلْمِيذُ", "оба слова"],
        explanation: "Мудаф иляйхи — второе имя, владелец; оно и стоит в джарре.",
      },
      {
        prompt: "Какое окончание получает второе имя связки?",
        promptLang: "ru",
        answer: "«-и», это джарр",
        options: ["«-и», это джарр", "«-у», это рафъ", "танвин «-ун»"],
        explanation: "التِّلْمِيذِ, الأُسْتَاذِ — родительный падеж, джарр.",
      },
      {
        prompt: "Исправьте ошибку в связке الأُسْتَاذُ التِّلْمِيذِ",
        promptLang: "ru",
        answer: "أُسْتَاذُ التِّلْمِيذِ",
        options: ["أُسْتَاذُ التِّلْمِيذِ", "الأُسْتَاذُ التِّلْمِيذُ", "أُسْتَاذٌ التِّلْمِيذِ"],
        explanation: "Мудаф не берёт ни артикля, ни танвина.",
      },
      {
        prompt: "Как сказать «врач торговца»?",
        promptLang: "ru",
        answer: "طَبِيبُ التَّاجِرِ",
        options: ["طَبِيبُ التَّاجِرِ", "التَّاجِرُ الطَّبِيبُ", "طَبِيبٌ تَاجِرٌ"],
        explanation: "Вещь впереди, владелец следом и в джарре.",
      },
      {
        prompt: "Откуда мудаф берёт определённость, если артикля у него нет?",
        promptLang: "ru",
        answer: "От второго слова связки",
        options: ["От второго слова связки", "От указательного слова", "Он остаётся неопределённым"],
        explanation: "Определённый владелец делает определённой и саму вещь.",
      },
      {
        prompt: "Какая запись означает «ученики тех наставников»?",
        promptLang: "ru",
        answer: "تَلَامِيذُ أُولَئِكَ الأَسَاتِذَةِ",
        options: [
          "تَلَامِيذُ أُولَئِكَ الأَسَاتِذَةِ",
          "أَسَاتِذَةُ أُولَئِكَ التَّلَامِيذِ",
          "أُولَئِكَ التَّلَامِيذُ أَسَاتِذَةُ",
        ],
        explanation: "Первым стоит то, о чём речь, — ученики; наставники идут вторыми и в джарре.",
      },
    ],
  },
};
