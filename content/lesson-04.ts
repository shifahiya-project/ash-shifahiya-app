  ...
  decks: [
    ...
    },
    {
      ...
      words: [
        ...
        { arabic: "عُلَمَاءُ", russian: "учёные (м. р.)" },
        { arabic: "عَالِمَةٌ", russian: "учёная" },
        { arabic: "عَالِمَاتٌ", russian: "учёные (ж. р.)", note: "женский род" },
        { arabic: "جَاهِلٌ", russian: "невежда / неучёный" },
        { arabic: "جُهَلَاءُ", russian: "невежды (м. р.)" },
        { arabic: "جَاهِلَةٌ", russian: "невежда", note: "женский род" },
        { arabic: "جَاهِلَاتٌ", russian: "невежды (ж. р.)", note: "женский род" },
      ],
    },
  ],
  questions: [
